...
/**
 * StatProcessor class contains the algorithm of mapping.log processing
 */
@AllArgsConstructor
public class StatProcessor {
    ...
    /**
     * Method, which aggregates source mapping.log
     * @param inputRdd input mapping.log represented as RDD of strings
     * @param interactionTypeMapping map, which contains associations between interaction type id and
     *                               interaction type name
     * @return RDD with aggregated mapping.log
     */
    public static JavaPairRDD<ReturnRecordKey, Long> calculate(JavaRDD<String> inputRdd,
        ...
        return inputRdd
                 ...
                 .map(x -> {
                     String [] row = x.split(",");
                     if (row.length != 4) throw new RuntimeException("Invalid number of columns in mapping.log csv");
